...
GOVERNED_PATHS = ["docs/"]
POINTER = ("Editing governed docs — the build brief in docs/handoff/ is authoritative "
           "(spike_spec.md wins on conflict); record design calls in docs/decisions/, "
           "not inline. docs/road.md is a tracker, not a spec.")
